...
const tokenDefinitions = [
  ...
  },
  {
    ...
    standard: "BFG-20",
    decimals: 18,
    unitBacking: "1 token = 1 MT Copper Concentrate",
    specification: "Cu 20-30%, beneficiated ore concentrate",
    origins: ["Chile", "Peru", "DRC"],
  },
  {
    id: "BFG-ALU",
    name: "Aluminium Ingots Token",
    symbol: "ALU",
  ...
  },
  {
    ...
    standard: "BFG-20",
    decimals: 18,
    unitBacking: "1 token = 1 BBL Gasoil 10ppm",
    specification: "10ppm max sulphur content",
    origins: ["Singapore", "UAE", "Netherlands"],
  },
  {
    id: "BFG-G50",
    name: "Gasoil 50ppm Token",
    symbol: "G50",
    commodity: "Gasoil 50ppm",
    category: "energy",
    icon: Flame,
    accent: "text-orange-600 dark:text-orange-400",
    accentBg: "bg-orange-600/10",
    standard: "BFG-20",
    decimals: 18,
    unitBacking: "1 token = 1 BBL Gasoil 50ppm",
    specification: "50ppm max sulphur content",
    origins: ["Singapore", "UAE", "Netherlands"],
  },
  {
    id: "BFG-LHC",
    ...
    standard: "BFG-20",
    decimals: 18,
    unitBacking: "1 token = 1 MT LHC",
    specification: "Low hydrocarbon fuel product",
    origins: ["Middle East", "Southeast Asia"],
  },
  {
    id: "BFG-HSF",
    name: "HSFO Token",
    symbol: "HSF",
    commodity: "HSFO (High Sulphur Fuel Oil)",
    category: "energy",
    icon: Flame,
    accent: "text-orange-600 dark:text-orange-400",
    accentBg: "bg-orange-600/10",
    standard: "BFG-20",
    decimals: 18,
    unitBacking: "1 token = 1 MT HSFO",
    specification: "High sulphur fuel oil, 3.5% max sulphur",
    origins: ["Russia", "Middle East", "Singapore"],
  },
  {
    id: "BFG-HSG",
    name: "HSGO Token",
    symbol: "HSG",
    commodity: "HSGO (High Sulphur Gas Oil 20000ppm)",
    category: "energy",
    icon: Flame,
    accent: "text-orange-600 dark:text-orange-400",
    accentBg: "bg-orange-600/10",
  ...
  {
    id: "BFG-PCA",
    name: "Petcoke \u2013 Anode Grade Token",
    symbol: "PCA",
    commodity: "Petcoke \u2013 Anode Grade",
    ...
    standard: "BFG-20",
    decimals: 18,
    unitBacking: "1 token = 1 MT Petcoke \u2013 Anode Grade",
    specification: "Low sulphur, high carbon, anode quality",
    origins: ["USA", "Saudi Arabia", "China"],
  },
  {
    id: "BFG-PCF",
    name: "Petcoke \u2013 Fuel Grade Token",
    symbol: "PCF",
    ...
    standard: "BFG-20",
    decimals: 18,
    unitBacking: "1 token = 1 MT Petcoke \u2013 Fuel Grade",
