                ...
                <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto">
                  ...
                  <div className="space-y-6 mt-4">
                    ...
                    <div className="flex justify-end gap-2 pt-4 border-t border-border">
                      ...
                      <Button onClick={() => { setShowPreview(false); handleSubmit({ preventDefault: () => {} } as React.FormEvent); }} disabled={submitKyc.isPending || uploadingCount > 0} data-testid="button-reg-preview-submit">
                        <UserCheck className="w-4 h-4 mr-2" />
                        {submitKyc.isPending ? "Submitting..." : uploadingCount > 0 ? `Uploading ${uploadingCount}…` : "Submit KYC Application"}
                      </Button>
                    </div>
