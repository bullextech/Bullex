                ...
                <div data-testid="kyc-register-section-2">
                  ...
                  <div className="mt-6 space-y-6">
                    <div className="space-y-2">
                      ...
                      <Textarea className={`${textareaClass} min-h-[120px]`} placeholder="Name, Date of Birth, Nationality, Passport No., Percentage held — one per line" value={form.ultimateBeneficialOwners} onChange={(e) => update("ultimateBeneficialOwners", e.target.value)} data-testid="input-reg-beneficial-owners" />
                    </div>
                    <div className="space-y-2">
                ...
                <div data-testid="kyc-register-section-3">
                  ...
                  <div className="mt-6 space-y-6">
                    <div className="space-y-2">
                      ...
                      <Textarea className={`${textareaClass} min-h-[120px]`} placeholder="Full Name — Nationality — DOB — Position (one per line)" value={form.managementStructure} onChange={(e) => update("managementStructure", e.target.value)} data-testid="input-reg-management" />
                    </div>
                    <div className="space-y-2">
